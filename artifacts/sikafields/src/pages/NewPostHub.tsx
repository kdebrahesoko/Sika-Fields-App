...
function FeatureChip({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <span
      ...
      style={{ color: FOREST_DEEP, background: "#fff7e7", border: `1px solid ${OCHRE_LIGHT}` }}
    >
    ...
    >
      ...
      >
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 h-14 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <Sprout className="w-4 h-4 shrink-0" style={{ color: FOREST }} />
            <p className="text-sm font-semibold">
              <span style={{ color: FOREST_DEEP }}>Create</span>
              <span className="hidden sm:inline" style={{ color: COCOA }}>
                {" "}· Choose how to start
              </span>
            </p>
          </div>
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-12 sm:py-16">
        ...
        >
          ...
          >
            How would you{" "}
            <span style={{ color: FOREST_DEEP, fontStyle: "italic", fontWeight: 500 }}>
              like to start?
            </span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-5 sm:gap-7">
          ...
          >
            <Link
              ...
              className="group block h-full p-7 sm:p-9 transition-all hover:-translate-y-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
              style={{
                background: "#fffaf0",
                border: `1.5px solid ${OCHRE_LIGHT}`,
                borderRadius: 22,
                boxShadow:
                  "0 1px 0 rgba(0,0,0,0.02), 0 14px 30px -18px rgba(120, 78, 32, 0.35), 0 4px 0 -2px #ead7b1",
              }}
            >
              <div className="flex items-center justify-between mb-5">
                <div
                  ...
                  style={{
                    ...
                    background: FOREST,
                    color: "#fffaf0",
                    boxShadow: `inset 0 -4px 0 ${FOREST_DEEP}`,
                  }}
                >
              ...
              <h2
                className="text-2xl sm:text-[26px] leading-tight mb-2.5"
                style={{ fontFamily: HEAD, fontWeight: 600, color: INK }}
              >
                Start from scratch
              </h2>
          ...
          >
            <Link
              ...
              className="group block h-full p-7 sm:p-9 transition-all hover:-translate-y-1.5 relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
              style={{
                background: "linear-gradient(160deg, #fff3d9 0%, #fffaf0 60%, #fde6c2 100%)",
                border: `1.5px solid ${OCHRE}`,
                borderRadius: 22,
                boxShadow:
                  "0 1px 0 rgba(0,0,0,0.02), 0 14px 30px -18px rgba(180, 110, 40, 0.4), 0 4px 0 -2px #e0bd7c",
              }}
            >
              <div
                ...
                <div className="flex items-center justify-between mb-5">
                  <div
                    ...
                    style={{
                      width: 52,
                      height: 52,
                      background: `linear-gradient(135deg, ${OCHRE} 0%, ${FOREST} 100%)`,
                      color: "#fffaf0",
        ...
        <p
          className="text-center text-xs mt-10 max-w-md mx-auto leading-relaxed"
          style={{ color: COCOA }}
        >
