...
import {
  ...
  ExternalLink, Edit3, Palette,
} from "lucide-react";
import { type Article } from "@/data/articles";
import { useArticle, useRelatedArticles } from "@/hooks/useArticles";
import { isSanityConfigured } from "@/lib/sanity";
import {
  TAG_COLORS, tagStyle, AuthorAvatar, ContentBlock, AuthorBio,
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 pt-6 border-t border-border">
              <div className="flex items-center gap-3">
                <AuthorAvatar author={article.author} size={11} rounded="rounded-xl" />
                <div>
